...
import { EventKey, DynamicRefForwardingComponent, TransitionCallbacks, TransitionComponent } from '@restart/ui/esm/types';
...
export declare function useTabPanel({ active, eventKey, mountOnEnter, transition, unmountOnExit, ...props }: TabPanelProps): [any, TabPanelMetadata];
